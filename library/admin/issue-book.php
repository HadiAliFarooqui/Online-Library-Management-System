...
<head>
    ...
    <title>Online Library Management System | Issue a new Book / Toy</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Issue a New Book / Toy</h4>
...
<div class="form-group">
<label>ISBN Number or Book / Toy Title<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Issue Book / Toy</button>
